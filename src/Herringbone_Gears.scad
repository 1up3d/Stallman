...
gear1_shaft_d = 5.7;  			// diameter of motor shaft
...
gear1_setscrew_offset = gear_h / 2;			// Distance from motor on motor shaft of grub screw.
gear1_setscrew_d         = 3.1 / cos(180 / 8) + 0.4;
gear1_setscrew_r          = gear1_setscrew_d/2;
gear1_captive_nut_d = 6.2 / cos(180 / 6) + 0.4;
gear1_captive_nut_r  = gear1_captive_nut_d/2;
gear1_captive_nut_h = 2.8;


// GEAR2 (LARGER GEAR, DRIVE SHAFT GEAR) OPTIONS:
gear2_teeth = 46;			// was 45 for Wade/Greg
gear2_shaft_d = 8.4;		// was 8.3 for Wade/Greg
gear2_shaft_r  = gear2_shaft_d/2;
// gear2 has settable outer shaft diameter.
gear2_shaft_outer_d = 20;	//was 20 for Wade/Greg
...
gear2_bolt_hex_d       = 13.3;		// was 12.8 for Greg/Wade
...
translate([0, 37, 0]) import("gregs-accessible-wade.stl");
