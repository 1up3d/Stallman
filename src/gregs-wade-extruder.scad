...
include<inc/configuration1.scad>
include<inc/functions1.scad>
...
idler_height=12;
idler_608_diameter=608_diameter+2; //bearing hole
idler_608_height=9;
	...
	difference()
	{
		...
		translate(idler_axis)
		{
			difference()
			{
				...
				rotate([180*i,0,0])
				translate([0,0,6.9/2])
				cylinder(r1=12/2,r2=16/2,h=2);  //thickness of bearing was r1=12/2
			}
