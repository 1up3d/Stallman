...
//Derived from:
// PRUSA Mendel Bushings by Josef Průša josefprusa@me.com prusadjs.cz http://www.reprap.org/wiki/Prusa_Mendel http://github.com/prusajr/PrusaMendel
...
translate(v=[-14,0,0])polyhole(m3_diameter, 10);// hole for y carriage
translate(v=[14,0,0])polyhole(m3_diameter, 10);// hole for y carriage
//hack
